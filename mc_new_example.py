...
num_episodes = 200
num_samples_per_inference = 10  # Number of samples per inference for aleatoric uncertainty
num_mc_inferences = 5           # Number of MC inferences for epistemic uncertainty
# Create a folder for all JSON files
output_dir = f"mc_dropout_{task_name}_{num_episodes}_episodes_{num_mc_inferences}_mc_{num_samples_per_inference}_samples"
